...
//       const findItem = userModel.find(item => item.nickname === userName && item.password === password);
...
//         if (flag) {
//           const { userId: itemUserId, nickname, userRole } = item;
//           Object.assign(userInfo, { userId: itemUserId, nickname, userRole });
//         }
//         return flag;
//       });
