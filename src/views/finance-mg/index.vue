<template>
  <div>
    <n-card title="财务管理" :bordered="false" class="h-full rounded-8px shadow-sm">
...
type TableDataProps = financeData
            ...
            trigger: () => {
              return (
                <div
                  ...
                  onClick={() => {
                    handleCopy(row.order_id)
                  }}>
                  <NP class="ellipsis-text whitespace-pre-wrap">{row.order_id}</NP>
                </div>
              )
            },
          }}>
