<template>
  <div>
    <n-card title="用户列表" :bordered="false" class="h-full rounded-8px shadow-sm">
...
const listData: houseData[] = [
  ...
  },
  {
    ...
    goodsName: '物料2',
    houseName: '仓库2',
    create_time: '2022-01-02 12:00:00',
    order_id: '123456789',
    number: 20,
  },
  {
    ...
    goodsName: '物料3',
    houseName: '仓库3',
    create_time: '2022-01-03 12:00:00',
    order_id: '123456789',
    number: 30,
  },
  {
  ...
  },
  {
    ...
    goodsName: '物料5',
    houseName: '仓库5',
    create_time: '2022-01-05 12:00:00',
    order_id: '123456789',
    number: 50,
  },
]

type TableDataProps = houseData
            ...
            trigger: () => {
              return (
                <div
                  ...
                  onClick={() => {
                    handleCopy(row.houseName)
                  }}>
                  <NP class="ellipsis-text whitespace-pre-wrap">{row.houseName}</NP>
                </div>
              )
            },
          }}>
